...
import cv2
face_cascade = cv2.CascadeClassifier('D:/Anaconda3/envs/tensorflow/Lib/site-packages/cv2/data/haarcascade_frontalface_alt.xml')
eye_cascade = cv2.CascadeClassifier('D:/Anaconda3/envs/tensorflow/Lib/site-packages/cv2/data/haarcascade_eye.xml')
img1 = cv2.imread('./picture/face2.png')
